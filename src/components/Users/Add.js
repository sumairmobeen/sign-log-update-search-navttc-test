        ...
        <Col lg={6} md={8} sm={10} xs={10}>
          <ListGroup>
            ...
            <ListGroup.Item variant="light">
              <Row>
                <Col className="col-headers" placeholder="Enter the Name">Name</Col>
                <Col>
                  <input type="text" name='name' onChange={(e)=>setName(e.target.value)} />
                </Col>
              </Row>
              <Row>
                <Col className="col-headers" placeholder="Enter E-mail">Email</Col>
                <Col>
                  <input type="text" name='email' onChange={(e)=>setEmail(e.target.value)} />
                </Col>
              </Row>
              <Row>
                <Col className="col-headers" placeholder="Enter the Password">Password</Col>
                <Col>
